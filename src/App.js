...
class AlbumDetails extends Component {
  render() {
    if (!this.props.album) return 'You are not part of this album / Loading album...';
    return (
      <Segment>
        ...
        <S3ImageUpload albumId={this.props.album.id} onChange={this.onChange} />        
...
class S3ImageUpload extends React.Component {
  constructor(props) {
    ...
    this.onChange = this.onChange.bind(PhotosList.render)
  }
